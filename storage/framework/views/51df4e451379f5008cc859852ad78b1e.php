        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex align-items-center">
                    <span class="badge bg-info fs-6"><?php echo e($users->total()); ?> Channel Users</span>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e($channel->telegram_channel_url); ?>" target="_blank" class="text-decoration-none">
                                        <span class="badge bg-info-subtle text-info fw-medium fs-6">
                                            <?php echo e($channel->telegram_channel_url); ?>
                        ...
                        <div class="col-md-4 text-md-end mt-3 mt-md-0">
                            <div class="d-flex flex-column align-items-md-end">
                                ...
                                <h4 class="mb-0 text-info"><?php echo e($users->total()); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <form action="<?php echo e(route('verified.user.search', $channel->id)); ?>" method="GET" class="d-flex">
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <?php if(request('query')): ?>
                                <a href="<?php echo e(route('channel.users', $channel->id)); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body p-0">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <?php if(request('query')): ?>
                                <a href="<?php echo e(route('channel.users', $channel->id)); ?>" class="btn btn-info mt-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project\back\resources\views/admin/channel_users.blade.php ENDPATH**/ ?>